...
if($_GET['search_location']){
  ...
  $sql = "SELECT * FROM turf_details WHERE location LIKE '%".$location."%'"; 
...
<body>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="index.php">Turf<span class="color-b">Booking</span></a>
        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Our Amazing Turf</h1>
                      ...
                      <div class="card-overlay-a-content">
                        <div class="card-header-a">
                          <h2 class="card-title-a">
                            <a href="#"><?php echo $row['turf_name']; ?></a>
                          </h2>
                        </div>
                        <div class="card-body-a">
                          <div class="price-box d-flex">
                            <span class="price-a">Fees | ₹ 1500</span>
                          </div>
                        ...
                        <div class="card-footer-a">
                          <ul class="card-info d-flex justify-content-around">
                            ...
                            <li>
                              <h4 class="card-info-title">Sports</h4>
                              <span>4</span>
                            </li>
                            <li>
                              <h4 class="card-info-title">Locker</h4>
                              <span>1</span>
                            </li>
                          </ul>
                        </div>
            ...
            <div class="container bcontent">
                <div class="card" style="width: 100%;">
                    <div class="row no-gutters">
                        <div class="col-sm-5">
                            <img class="card-img" src="./images/<?php echo $row['turf_images']; ?>" alt="Suresh Dasari Card">
                        </div>
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo $row['turf_name']; ?></h5>
                                <p class="card-text"><?php echo $row['turf_address']; ?></p>
        ...
        <div class="col-md-12">
          ...
          <div class="copyright-footer">
            <p class="copyright color-text-a">
              &copy; Copyright
              <span class="color-a">TurfBooking</span> All Rights Reserved.
            </p>
          </div>
        </div>
      </div>
